...
export default function CardDemo() {
  return (
    <Card>
      ...
      <CardTitle>Smart Model Orchestration</CardTitle>
      <CardDescription>
        Route one prompt across your best models, compare outputs instantly,
        and ship decisions faster inside one premium VEL workspace.
      </CardDescription>
    </Card>
  );
}
    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row shrink-0 justify-center items-center gap-2">
        ...
        <Container className="h-12 w-12 circle-2">
          <CopilotGlyph className="h-6 w-6 dark:text-white" />
        </Container>
...
const CopilotGlyph = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
    <path d="M6.5 7.5a5.5 5.5 0 0 1 10.95-.74 4.5 4.5 0 0 1 1.55 8.72A4.5 4.5 0 0 1 15.5 20h-7A4.5 4.5 0 0 1 4 15.5v-.2A4.5 4.5 0 0 1 6.5 7.5Z" stroke="currentColor" strokeWidth="1.6"/>
    <circle cx="9" cy="12" r="1.2" fill="currentColor"/>
    <circle cx="15" cy="12" r="1.2" fill="currentColor"/>
    <path d="M9 16c.9.65 1.9 1 3 1s2.1-.35 3-1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
