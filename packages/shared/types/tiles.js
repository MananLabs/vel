...
exports.getAvailableTiles = exports.getTileConfig = exports.TILE_CONFIGS = exports.TILE_TYPES = void 0;
exports.TILE_TYPES = [
    'ai-chat',
    'consensus',
    'terminal',
...
const getTileConfig = (type) => exports.TILE_CONFIGS.find((t) => t.type === type);
exports.getTileConfig = getTileConfig;
const getAvailableTiles = () => exports.TILE_CONFIGS.filter((t) => t.available);
